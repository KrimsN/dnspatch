...
// Config holds the parameters of the ipify retriever.
type Config struct {
	BaseURL string `toml:"base_url" default:"https://api64.ipify.org" doc:"Base URL of the service; api64.ipify.org is dual-stack and replies over whichever IP family the request arrives on"`
