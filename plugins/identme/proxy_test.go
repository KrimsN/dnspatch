...
func TestRetrieverIgnoresProxyEnvironmentByDefault(t *testing.T) {
	...
	base := Config{BaseURL: "https://ident.me", Family: "ipv4"}
...
func TestRetrieverBadProxyFailsAtConstruction(t *testing.T) {
	cfg := withProxy(Config{BaseURL: "https://ident.me", Family: "ipv4"}, "ftp://u:"+proxyPass+"@proxy.example.com")
