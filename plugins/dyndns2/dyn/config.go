...
type Config struct {
	...
	Password string `toml:"password,required" example:"${PASSWORD}" doc:"Updater client key of the account, created in the account settings; it is not the account password"`
