...
func TestNewRetrieverValidation(t *testing.T) {
	tests := []struct {
		...
		{name: "bad family", cfg: Config{BaseURL: "https://icanhazip.com", Family: "carrier-pigeon"}, wantErr: "family"},
		{name: "bad url", cfg: Config{BaseURL: "icanhazip.com", Family: "ipv4"}, wantErr: "base_url"},
		{name: "bad url with a login", cfg: Config{BaseURL: "ftp://user:hunter2@icanhazip.com", Family: "ipv4"}, wantErr: "base_url"},
		{name: "unparsable url with a password", cfg: Config{BaseURL: "https://user:hunter2@icanhazip.com/%zz", Family: "ipv4"}, wantErr: "base_url"},
		{name: "family is case-insensitive", cfg: Config{BaseURL: "https://icanhazip.com", Family: "IPv6"}},
		{name: "both is accepted", cfg: Config{BaseURL: "https://icanhazip.com", Family: "both"}},
		{name: "ipv64 is an alias for both", cfg: Config{BaseURL: "https://icanhazip.com", Family: "ipv64"}},
	}
