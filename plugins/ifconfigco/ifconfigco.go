...
// single response carrying both addresses. Both requests happen within the
// same poll, so the one-request-per-minute limit below is still respected as
// long as the polling interval is.
//
