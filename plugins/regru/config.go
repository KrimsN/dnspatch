...
type Config struct {
	...
	Password string `toml:"password,required" example:"${PASSWORD}" doc:"API password; set an alternative password for the API in the REG.RU account and allow the address dnspatch runs from"`
