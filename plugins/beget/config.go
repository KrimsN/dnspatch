...
type Config struct {
	Login    string `toml:"login,required" doc:"Beget account login used for API calls"`
	Password string `toml:"password,required" example:"${PASSWORD}" doc:"Beget account password"`
